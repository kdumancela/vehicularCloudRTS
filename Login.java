...
* Due: October 25, 2022
* This class is used to create a functional sign in page and based on user will lead to a corresponding home page.
*/
...
public class Login {
	...
	private JLabel titleFrame, username, password;
	...
	public Login() {
		...
		imageLabel.setFont(new Font("Times", Font.BOLD, 20)); */
